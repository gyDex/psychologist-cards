...
export const TimeStage:React.FC<Props> = ({callback}) => {
    return (
        <ModalWindow type='Time'>
            ...
            <DialogFooter>
                <Button onClick={callback} className="cursor-pointer w-full hover:bg-[#116466] bg-[#116466] rounded-[50px] text-[white] py-[25px] font-normal  text-[18px]" type="button">Далее</Button>
            </DialogFooter>
        </ModalWindow>
    );
};