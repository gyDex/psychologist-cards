            ...
            <Form {...form} >
                <form onSubmit={form.handleSubmit(handleSubmit)} className=" border-[#D4D4D4] w-full flex flex-col h-[100%]">
                        ...
                        render={({  }) => (
                            <div className='grow '>
                                <FormItem className='grow p-[25px] max-lg:p-[15px] border-[1px] rounded-[25px]  '>
                                    ...
                                    <FormDescription className='max-lg:text-[14px] max-lg:w-full font-normal text-[18px]  leading-[25px] mt-[5px]  '>
                    ...
                    <div className="shrink-0 mt-[25px]  pb-[40px] flex gap-[10px]">
                        <button onClick={() => dispatch(toNextStage('condition'))} className="cursor-pointer shrink-0 w-[81px] border-[1px] border-[#116466] p-[12px] text-[#116466] font-normal text-[14px] rounded-[50px]">
                            Назад
                        </button>
