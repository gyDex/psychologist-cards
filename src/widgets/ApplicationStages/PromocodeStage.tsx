...
import { fill_age, fill_username } from '@/redux/slices/application_form_data';
            ...
            <Form {...form} >
                <form onSubmit={form.handleSubmit(handleSubmit)} className="w-full flex flex-col h-[100%]">
                        ...
                        render={({ field }) => (
                            <div className='grow'>
                                <FormItem className='grow'>
                                    <FormLabel className='max-lg:text-[16px] font-semibold text-[20px] leading-[100%]'>Введите промокод или номер подарочного сертификата</FormLabel>
                                    ...
                                    <FormControl className='mt-[20px]'>
                                        <Input className='bg-[#FAFAFA] placeholder:max-lg:text-[14px] placeholder:text-[18px]  rounded-[10px] border-none w-full h-[65px]' placeholder="Введите промокод или номер подарочного сертификата" {...field} />
                                    </FormControl>
                                </FormItem>
                            </div>
                        )}
                    ...
                    <div className="shrink-0  pb-[40px] flex gap-[10px]">
                        <button type='button' onClick={() => dispatch(toNextStage('diseases'))} className="cursor-pointer shrink-0 w-[81px] border-[1px] border-[#116466] p-[12px] text-[#116466] font-normal text-[14px] rounded-[50px]">
                            Назад
                        </button>
