...
export const ModalWindow:React.FC<Props> = ({maxWidth, closeButton = true, children, type}) => {
    ...
    return (
        <>
            <Dialog  onOpenChange={() => dispatch(close())} open={isOpen && isOpenType === type} >
                ...
                <DialogContent maxWidth={maxWidth} className=" w-[95%] max-w-[640px] p-[30px] rounded-[30px]">
                {
